...
_CONVERSATIONINPUT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='trans_id', full_name='Seq2SeqGRPC.ConversationInput.trans_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='text', full_name='Seq2SeqGRPC.ConversationInput.text', index=1,
...
_CONVERSATIONRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='trans_id', full_name='Seq2SeqGRPC.ConversationResponse.trans_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='state', full_name='Seq2SeqGRPC.ConversationResponse.state', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='text', full_name='Seq2SeqGRPC.ConversationResponse.text', index=2,
