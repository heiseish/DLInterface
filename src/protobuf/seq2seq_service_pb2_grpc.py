...
class Seq2SeqServiceStub(object):
    ...
    """
        self.RespondToText = channel.unary_unary(
            ...
            request_serializer=seq2seq__service__pb2.ConversationInput.
            SerializeToString,
            response_deserializer=seq2seq__service__pb2.ConversationResponse.
            FromString,
        )
    ...
    rpc_method_handlers = {
        'RespondToText':
            grpc.unary_unary_rpc_method_handler(
                ...
                request_deserializer=seq2seq__service__pb2.ConversationInput.
                FromString,
                response_serializer=seq2seq__service__pb2.ConversationResponse.
                SerializeToString,
            ),
    }
