...
class ImageClassificationServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.RecognizeImage = channel.unary_unary(
        ...
        request_serializer=image__classification__service__pb2.ImageRequest.SerializeToString,
        response_deserializer=image__classification__service__pb2.ImageResponse.FromString,
        )
...
def add_ImageClassificationServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'RecognizeImage': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=image__classification__service__pb2.ImageRequest.FromString,
          response_serializer=image__classification__service__pb2.ImageResponse.SerializeToString,
      ),
  }
  generic_handler = grpc.method_handlers_generic_handler(
      'ImageClassificationServiceRPC.ImageClassificationService', rpc_method_handlers)
