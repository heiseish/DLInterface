...
_IMAGEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='trans_id', full_name='ImageClassificationServiceRPC.ImageRequest.trans_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='image', full_name='ImageClassificationServiceRPC.ImageRequest.image', index=1,
...
_IMAGERESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='trans_id', full_name='ImageClassificationServiceRPC.ImageResponse.trans_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='state', full_name='ImageClassificationServiceRPC.ImageResponse.state', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='text', full_name='ImageClassificationServiceRPC.ImageResponse.text', index=2,
...
_IMAGECLASSIFICATIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='RecognizeImage',
    full_name='ImageClassificationServiceRPC.ImageClassificationService.RecognizeImage',
    index=0,
...
DESCRIPTOR.services_by_name['ImageClassificationService'] = _IMAGECLASSIFICATIONSERVICE
